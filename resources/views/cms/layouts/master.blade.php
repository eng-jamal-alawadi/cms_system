...
<head>
    ...
    <title>Tasks-System| @yield('title')</title>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{route('dashboard')}}" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Tasks-System</span>
            </a>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="{{route('dashboard')}}">@yield('main_page')</a></li>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; {{now()->year}} - {{now()->year+1}} <a href="{{route('dashboard')}}">Tasks-System</a>.</strong> All rights
            reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
